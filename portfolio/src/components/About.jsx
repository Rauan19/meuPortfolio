...
import Curriculo from '../imgs/Currículo - Desenvolvedor Full Stack.pdf'
const About = () => {
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 md:flex items-center">
          ...
          <div>
            ...
            <a
              href={Curriculo || "file:///C:/Users/pcdev/Downloads/portfolio-mosaic-dream-main%20(1)/portfolio/src/imgs/Curr%C3%ADculo%20-%20Desenvolvedor%20Full%20Stack.pdf"}
